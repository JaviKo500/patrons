...
class DatabaseConnection {
  ...
  public connect(): void {
    if (this.connected) {
      console.log('%c Ya estás conectado a la base de datos:', COLORS.green);
      return;
    }
    this.connected = true;
    console.log('%Conectado a la base de datos:', COLORS.green);
  }
  ...
  public disconnect(): void {
    ...
    if (!this.connected) {
      console.log('%c No estás conectado a la base de datos:', COLORS.red);
